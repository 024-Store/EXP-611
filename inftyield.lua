...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Infinite Yield está aguardando o jogo carregar'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Cmdbar.Text = ""
Cmdbar.ZIndex = 10
Cmdbar.PlaceholderText = "Barra de Comandos"
...
ColorsButton = makeSettingsButton("Editar Tema","rbxassetid://4911962991")
ColorsButton.Position = UDim2.new(0,5,0,55)
ColorsButton.Size = UDim2.new(1,-10,0,25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Editar Teclas de Atalho","rbxassetid://129697930")
...
StayOpen.Text = "Manter Menu Aberto"
...
Positions = makeSettingsButton("Editar/Ir para Waypoints","rbxassetid://5147488592")
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Editar Ligações de Eventos","rbxassetid://5147695474",759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Gerenciar Plugins","rbxassetid://5147695474",743)
...
Title_2.TextSize = 14
Title_2.Text = "Título da Notificação"
...
Text_2.TextSize = 16
Text_2.Text = "Texto da Notificação"
...
Directions.Text = "Clique no botão abaixo e pressione uma tecla/botão do mouse. Depois selecione o que você quer ligar a ela."
...
BindTo.Text = "Clique para vincular"
...
ClickTP.Text = "    Teleporte por Clique (Segure a Tecla e Clique)"
...
ClickDelete.Text = "    Excluir por Clique (Segure a Tecla e Clique)"
...
Cmdbar_2.PlaceholderText = "Comando"
Cmdbar_2.Text = ""
...
Cmdbar_3.PlaceholderText = "Comando 2"
Cmdbar_3.Text = ""
...
CreateToggle.Text = "Criar Alternância"
...
PopupText_2.Text = "Definir Teclas de Atalho"
...
AddPlugin.Text = "Adicionar Plugin"
...
FileName.Text = "Nome do Arquivo do Plugin"
...
About.TextSize = 14
About.Text = "Plugins são arquivos .iy e devem estar localizados na pasta 'workspace' do seu exploit."
...
Directions_2.Text = "Digite o nome do arquivo do plugin que você quer adicionar abaixo."
...
PopupText_3.Text = "Adicionar Plugins"
...
AliasHint.Text = "Adicione aliases usando o comando 'addalias'"
...
PluginsHint.Text = "Baixe plugins do Discord do IY (discord.io/infiniteyield)"
...
PositionsHint.Text = "Use o comando 'swp' ou 'setwaypoint' para adicionar uma posição usando seu personagem (NOTA: Teleportes de partes não serão salvos)"
...
ChoosePart.Text = "Selecionar Parte"
...
Directions_3.Text = 'Clique em uma parte e depois clique no botão "Selecionar Parte" abaixo para defini-la como localização de teleporte'
...
PopupText_5.Text = "Teleportar para Parte"
...
SaveChatlogs.Text = "Salvar em .txt"
...
selectChat.Text = "Registros de Chat"
...
selectJoin.Text = "Registros de Entrada"
...
function toClipboard(String)
	...
	if clipBoard then
		clipBoard(String)
		notify('Área de Transferência','Copiado para a área de transferência')
	else
		notify('Área de Transferência',"Seu exploit não tem a capacidade de usar a área de transferência")
	end
end
...
eventEditor = (function()
	...
	local main = create({
		...
		{3,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={2},Position=UDim2.new(0,0,0,0),Size=UDim2.new(1,0,0.95,0),Text="Editor de Eventos",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=Enum.TextXAlignment.Center,ZIndex=10,}},
		...
		{16,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={11},Size=UDim2.new(1,0,0,20),Text="Configurações de Eventos",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		...
		{20,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={19},Size=UDim2.new(1,0,0,20),Text="Escolher Jogadores",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{21,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={19},Position=UDim2.new(0,5,0,42),Size=UDim2.new(1,-10,0,20),Text="Qualquer Jogador",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{24,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Me",Parent={19},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="Apenas Eu",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{31,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={30},Size=UDim2.new(1,0,0,20),Text="Escolher String",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{32,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={30},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="Qualquer String",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{55,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Title",Parent={54},Size=UDim2.new(1,0,0,20),Text="Escolher String",TextColor3=Color3.new(1,1,1),TextSize=14,ZIndex=10,}},
		{56,"TextLabel",{BackgroundColor3=Color3.new(0.1803921610117,0.1803921610117,0.1843137294054),BackgroundTransparency=1,BorderSizePixel=0,Font=3,Name="Any",Parent={54},Position=UDim2.new(0,5,0,20),Size=UDim2.new(1,-10,0,20),Text="Qualquer Número",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
		...
		{46,"TextBox",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,ClearTextOnFocus=false,Font=3,Parent={45},PlaceholderColor3=Color3.new(0.7843137383461,0.7843137383461,0.7843137383461),PlaceholderText="Adicionar novo comando",Position=UDim2.new(0,5,0,0),Size=UDim2.new(1,-10,1,0),Text="",TextColor3=Color3.new(1,1,1),TextSize=14,TextXAlignment=0,ZIndex=10,}},
	...
	local function openSettingsEditor(event,cmd)
		...
		for i,v in pairs(event.sets) do
			...
			elseif v.Type == "Number" then
				...
				template.Title.Text = v.Name or "Número"
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			...
			inviteButton.Text = "Copiado"
		else
			inviteButton.Text = "Sem Função de Área de Transferência, digite o link"
		end
		local pressTime = tick()
		lastPress = pressTime
		wait(2)
		if lastPress ~= pressTime then return end
		inviteButton.Text = "Copiar Link de Convite do Discord (https://discord.io/infiniteyield)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
if not writefileExploit() then
	notify('Salvamentos','Seu exploit não suporta ler/escrever arquivo. Suas configurações não serão salvas.')
end
...
SaveChatlogs.MouseButton1Down:Connect(function()
	if writefileExploit() then
		if #scroll_2:GetChildren() > 0 then
			notify("Carregando",'Aguarde um momento')
			...
			nameFile()
			notify('Registros de Chat','Registros de chat salvos na pasta workspace dentro da pasta do seu exploit.')
		end
	else
		notify('Registros de Chat','Seu exploit não suporta escrever arquivo. Você não pode salvar registros de chat.')
	end
end)
...
Players.PlayerRemoving:Connect(function(player)
	...
	if viewing ~= nil and player == viewing then
		...
		notify('Espectar','Visualização desligada (jogador saiu)')
	end
end)
...
Delete.MouseButton1Click:Connect(function()
	...
	refreshbinds()
	updatesaves()
	notify('Teclas de Atalho Atualizadas','Todas as teclas de atalho removidas')
end)
...
CopyPath.MouseButton1Click:Connect(function()
	if Path.Text ~= "" then
		...
		notify('Copiar Caminho','Selecione uma parte para copiar seu caminho')
	end
end)
	...
	if Path.Text ~= "" then
		...
		local function handleWpNames()
			...
			if not FoundDupe then
				notify('Waypoints Modificados',"Waypoint criado: "..selected.Adornee.Name..tpNameExt)
		...
		notify('Seleção de Parte','Selecione uma parte primeiro')
	end
end)
...
Delete_3.MouseButton1Click:Connect(function()
	customAlias = {}
	aliases = {}
	notify('Aliases Modificados','Todos os aliases removidos')
	updatesaves()
	refreshaliases()
end)
...
PrefixBox:GetPropertyChangedSignal("Text"):Connect(function()
	...
	Cmdbar.PlaceholderText = "Barra de Comandos ("..prefix..")"
	updatesaves()
end)
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'discord / support / help', DESC = 'Convidar para o servidor de suporte do Infinite Yield.'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = 'Carrega o console antigo do Roblox'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Abre o explorador DEX'}
CMDs[#CMDs + 1] = {NAME = 'remotespy / rspy', DESC = 'Abre o FrostHook Spy'}
CMDs[#CMDs + 1] = {NAME = 'audiologger / alogger', DESC = 'Abre o registrador de áudio do Edges'}
CMDs[#CMDs + 1] = {NAME = 'serverinfo / info', DESC = 'Fornece informações sobre o servidor'}
CMDs[#CMDs + 1] = {NAME = 'jobid', DESC = 'Copia o JobId do jogo para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'notifyjobid', DESC = 'Notifica você do JobId do jogo'}
CMDs[#CMDs + 1] = {NAME = 'rejoin / rj', DESC = 'Faz você reentrar no jogo'}
CMDs[#CMDs + 1] = {NAME = 'autorejoin / autorj', DESC = 'Reentra automaticamente no servidor se você for expulso/desconectado'}
CMDs[#CMDs + 1] = {NAME = 'serverhop / shop', DESC = 'Teleporta você para um servidor diferente'}
CMDs[#CMDs + 1] = {NAME = 'joinplayer [username / ID] [place ID]', DESC = 'Entra no servidor de um jogador específico'}
CMDs[#CMDs + 1] = {NAME = 'gameteleport / gametp [place ID]', DESC = 'Entra em um jogo por ID'}
CMDs[#CMDs + 1] = {NAME = 'antiidle / antiafk', DESC = 'Impede que o jogo expulse você por estar inativo/afk'}
CMDs[#CMDs + 1] = {NAME = 'datalimit [num]', DESC = 'Define o limite de KBPS de saída'}
CMDs[#CMDs + 1] = {NAME = 'replicationlag / backtrack [num]', DESC = 'Define IncomingReplicationLag'}
CMDs[#CMDs + 1] = {NAME = 'creatorid / creator', DESC = 'Notifica você do ID do criador'}
CMDs[#CMDs + 1] = {NAME = 'copycreatorid / copycreator', DESC = 'Copia o ID do criador para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'setcreatorid / setcreator', DESC = 'Define seu userid para o ID do criador'}
CMDs[#CMDs + 1] = {NAME = 'noprompts', DESC = 'Impede que o jogo mostre avisos de compra/premium'}
CMDs[#CMDs + 1] = {NAME = 'showprompts', DESC = 'Permite que o jogo mostre avisos de compra/premium novamente'}
CMDs[#CMDs + 1] = {NAME = 'enable [inventory/playerlist/chat/reset/all]', DESC = 'Alterna a visibilidade dos itens do coregui'}
CMDs[#CMDs + 1] = {NAME = 'disable [inventory/playerlist/chat/reset/all]', DESC = 'Alterna a visibilidade dos itens do coregui'}
CMDs[#CMDs + 1] = {NAME = 'showguis', DESC = 'Mostra qualquer GUI invisível'}
CMDs[#CMDs + 1] = {NAME = 'unshowguis', DESC = 'Desfaz showguis'}
CMDs[#CMDs + 1] = {NAME = 'hideguis', DESC = 'Esconde qualquer GUI no PlayerGui'}
CMDs[#CMDs + 1] = {NAME = 'unhideguis', DESC = 'Desfaz hideguis'}
CMDs[#CMDs + 1] = {NAME = 'guidelete', DESC = 'Habilita backspace para deletar GUI'}
CMDs[#CMDs + 1] = {NAME = 'unguidelete / noguidelete', DESC = 'Desabilita guidelete'}
CMDs[#CMDs + 1] = {NAME = 'hideiy', DESC = 'Esconde a GUI principal do IY'}
CMDs[#CMDs + 1] = {NAME = 'showiy / unhideiy', DESC = 'Mostra IY novamente'}
CMDs[#CMDs + 1] = {NAME = 'keepiy', DESC = 'Executa IY automaticamente quando você teleporta entre servidores'}
CMDs[#CMDs + 1] = {NAME = 'unkeepiy', DESC = 'Desabilita keepiy'}
CMDs[#CMDs + 1] = {NAME = 'togglekeepiy', DESC = 'Alterna keepiy'}
CMDs[#CMDs + 1] = {NAME = 'savegame / saveplace', DESC = 'Usa saveinstance para salvar o jogo'}
CMDs[#CMDs + 1] = {NAME = 'clearerror', DESC = 'Limpa a caixa irritante e o desfoque quando um jogo te expulsa'}
CMDs[#CMDs + 1] = {NAME = 'clientantikick / antikick (CLIENT)', DESC = 'Impede que localscripts te expulsem'}
CMDs[#CMDs + 1] = {NAME = 'clientantiteleport / antiteleport (CLIENT)', DESC = 'Impede que localscripts te teleportem'}
CMDs[#CMDs + 1] = {NAME = 'allowrejoin / allowrj [true/false] (CLIENT)', DESC = 'Muda se antiteleport permite que você reentre ou não'}
CMDs[#CMDs + 1] = {NAME = 'cancelteleport / canceltp', DESC = 'Cancela teleportes em andamento'}
CMDs[#CMDs + 1] = {NAME = 'volume / vol [0-10]', DESC = 'Ajusta o volume do seu jogo em uma escala de 0 a 10'}
CMDs[#CMDs + 1] = {NAME = 'antilag / boostfps / lowgraphics', DESC = 'Reduz a qualidade do jogo para aumentar FPS'}
CMDs[#CMDs + 1] = {NAME = 'record / rec', DESC = 'Inicia o gravador do roblox'}
CMDs[#CMDs + 1] = {NAME = 'screenshot / scrnshot', DESC = 'Tira uma captura de tela'}
CMDs[#CMDs + 1] = {NAME = 'togglefullscreen / togglefs', DESC = 'Alterna tela cheia'}
CMDs[#CMDs + 1] = {NAME = 'notify [text]', DESC = 'Envia uma notificação com o texto fornecido'}
CMDs[#CMDs + 1] = {NAME = 'lastcommand / lastcmd', DESC = 'Executa o comando anterior usado'}
CMDs[#CMDs + 1] = {NAME = 'exit', DESC = 'Mata o processo do roblox'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'noclip', DESC = 'Atravessar objetos'}
CMDs[#CMDs + 1] = {NAME = 'unnoclip / clip', DESC = 'Desabilita noclip'}
CMDs[#CMDs + 1] = {NAME = 'fly [speed]', DESC = 'Faz você voar'}
CMDs[#CMDs + 1] = {NAME = 'unfly', DESC = 'Desabilita fly'}
CMDs[#CMDs + 1] = {NAME = 'flyspeed [num]', DESC = 'Define a velocidade de voo (padrão é 20)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclefly / vfly [speed]', DESC = 'Faz você voar em um veículo'}
CMDs[#CMDs + 1] = {NAME = 'unvehiclefly / unvfly', DESC = 'Desabilita fly de veículo'}
CMDs[#CMDs + 1] = {NAME = 'vehicleflyspeed  / vflyspeed [num]', DESC = 'Define a velocidade de voo do veículo'}
CMDs[#CMDs + 1] = {NAME = 'cframefly / cfly [speed]', DESC = 'Faz você voar, contornando alguns anti-cheats (funciona em mobile)'}
CMDs[#CMDs + 1] = {NAME = 'uncframefly / uncfly', DESC = 'Desabilita cfly'}
CMDs[#CMDs + 1] = {NAME = 'cframeflyspeed  / cflyspeed [num]', DESC = 'Define a velocidade do cfly'}
CMDs[#CMDs + 1] = {NAME = 'qefly [true / false]', DESC = 'habilita ou desabilita as teclas de atalho Q e E para voo'}
CMDs[#CMDs + 1] = {NAME = 'vehiclenoclip / vnoclip', DESC = 'Desliga a colisão do veículo'}
CMDs[#CMDs + 1] = {NAME = 'vehicleclip / vclip / unvnoclip', DESC = 'Habilita a colisão do veículo'}
CMDs[#CMDs + 1] = {NAME = 'float /  platform', DESC = 'Gera uma plataforma abaixo de você fazendo você flutuar'}
CMDs[#CMDs + 1] = {NAME = 'unfloat / noplatform', DESC = 'Remove a plataforma'}
CMDs[#CMDs + 1] = {NAME = 'swim', DESC = 'Permite que você nade no ar'}
CMDs[#CMDs + 1] = {NAME = 'unswim / noswim', DESC = 'Impede que você nade em todos os lugares'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'setwaypoint / swp [name]', DESC = 'Define um waypoint na sua posição'}
CMDs[#CMDs + 1] = {NAME = 'waypointpos / wpp [name] [X Y Z]', DESC = 'Define um waypoint com coordenadas especificadas'}
CMDs[#CMDs + 1] = {NAME = 'waypoints', DESC = 'Mostra uma lista de waypoints ativos atualmente'}
CMDs[#CMDs + 1] = {NAME = 'showwaypoints / showwp', DESC = 'Mostra todos os waypoints definidos atualmente'}
CMDs[#CMDs + 1] = {NAME = 'hidewaypoints / hidewp', DESC = 'Esconde waypoints mostrados'}
CMDs[#CMDs + 1] = {NAME = 'waypoint / wp [name]', DESC = 'Teleporta o jogador para um waypoint'}
CMDs[#CMDs + 1] = {NAME = 'tweenwaypoint / twp [name]', DESC = 'Faz tween do jogador para um waypoint'}
CMDs[#CMDs + 1] = {NAME = 'walktowaypoint / wtwp [name]', DESC = 'Faz o jogador caminhar até um waypoint'}
CMDs[#CMDs + 1] = {NAME = 'deletewaypoint / dwp [name]', DESC = 'Exclui um waypoint'}
CMDs[#CMDs + 1] = {NAME = 'clearwaypoints / cwp', DESC = 'Limpa todos os waypoints'}
CMDs[#CMDs + 1] = {NAME = 'cleargamewaypoints / cgamewp', DESC = 'Limpa todos os waypoints do jogo em que você está'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'goto [plr]', DESC = 'Ir para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'tweengoto / tgoto [plr]', DESC = 'Fazer tween para um jogador (contorna alguns anti-cheats)'}
CMDs[#CMDs + 1] = {NAME = 'tweenspeed / tspeed [num]', DESC = 'Define a velocidade de todos os comandos tween (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = 'vehiclegoto / vgoto [plr]', DESC = 'Ir para um jogador enquanto estiver em um veículo'}
CMDs[#CMDs + 1] = {NAME = 'loopgoto [plr] [distance] [delay]', DESC = 'Teleportar em loop para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'unloopgoto', DESC = 'Para de teleportar você para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'pulsetp / ptp [plr] [seconds]', DESC = 'Teleporta você para um jogador por uma quantidade especificada de tempo'}
CMDs[#CMDs + 1] = {NAME = 'clientbring / cbring [plr] (CLIENT)', DESC = 'Trazer um jogador'}
CMDs[#CMDs + 1] = {NAME = 'loopbring [plr] [distance] [delay] (CLIENT)', DESC = 'Loop traz um jogador para você (útil para matar)'}
CMDs[#CMDs + 1] = {NAME = 'unloopbring [plr]', DESC = 'Desfaz loopbring'}
CMDs[#CMDs + 1] = {NAME = 'freeze / fr [plr] (CLIENT)', DESC = 'Congela um jogador'}
CMDs[#CMDs + 1] = {NAME = 'freezeanims', DESC = 'Congela suas animações / pausa suas animações - Não funciona em animações padrão'}
CMDs[#CMDs + 1] = {NAME = 'unfreezeanims', DESC = 'Descongela suas animações / reproduz suas animações'}
CMDs[#CMDs + 1] = {NAME = 'thaw / unfr [plr] (CLIENT)', DESC = 'Descongela um jogador'}
CMDs[#CMDs + 1] = {NAME = 'tpposition / tppos [X Y Z]', DESC = 'Teleporta você para certas coordenadas'}
CMDs[#CMDs + 1] = {NAME = 'tweentpposition / ttppos [X Y Z]', DESC = 'Fazer tween para coordenadas (contorna alguns anti-cheats)'}
CMDs[#CMDs + 1] = {NAME = 'offset [X Y Z]', DESC = 'Desloca você por certas coordenadas'}
CMDs[#CMDs + 1] = {NAME = 'tweenoffset / toffset [X Y Z]', DESC = 'Tween de deslocamento (contorna alguns anti-cheats)'}
CMDs[#CMDs + 1] = {NAME = 'notifyposition / notifypos [plr]', DESC = 'Notifica você das coordenadas de um personagem'}
CMDs[#CMDs + 1] = {NAME = 'copyposition / copypos [plr]', DESC = 'Copia as coordenadas de um personagem para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'walktoposition / walktopos [X Y Z]', DESC = 'Faz você caminhar até uma coordenada'}
CMDs[#CMDs + 1] = {NAME = 'spawnpoint / spawn [delay]', DESC = 'Define uma posição onde você nascerá'}
CMDs[#CMDs + 1] = {NAME = 'nospawnpoint / nospawn', DESC = 'Remove seu ponto de spawn personalizado'}
CMDs[#CMDs + 1] = {NAME = 'flashback / diedtp', DESC = 'Teleporta você para onde você morreu pela última vez'}
CMDs[#CMDs + 1] = {NAME = 'walltp', DESC = 'Teleporta você acima/sobre qualquer parede que você encontrar'}
CMDs[#CMDs + 1] = {NAME = 'nowalltp / unwalltp', DESC = 'Desabilita walltp'}
CMDs[#CMDs + 1] = {NAME = 'teleporttool / tptool', DESC = 'Dá a você uma ferramenta de teleporte'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'logs', DESC = 'Abre a GUI de registros'}
CMDs[#CMDs + 1] = {NAME = 'chatlogs / clogs', DESC = 'Registra o que as pessoas dizem ou sussurram'}
CMDs[#CMDs + 1] = {NAME = 'joinlogs / jlogs', DESC = 'Registra quando pessoas entram'}
CMDs[#CMDs + 1] = {NAME = 'chat / say [text]', DESC = 'Faz você enviar uma mensagem no chat (possível bypass de mudo)'}
CMDs[#CMDs + 1] = {NAME = 'spam [text]', DESC = 'Faz você fazer spam no chat'}
CMDs[#CMDs + 1] = {NAME = 'unspam', DESC = 'Desliga spam'}
CMDs[#CMDs + 1] = {NAME = 'whisper / pm [plr] [text]', DESC = 'Faz você sussurrar uma mensagem para alguém (possível bypass de mudo)'}
CMDs[#CMDs + 1] = {NAME = 'pmspam [plr] [text]', DESC = 'Faz você fazer spam nos sussurros de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'unpmspam [plr]', DESC = 'Desliga spam de mensagem privada'}
CMDs[#CMDs + 1] = {NAME = 'spamspeed [num]', DESC = 'Quão rápido você faz spam (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = 'bubblechat (CLIENT)', DESC = 'Habilita chat de bolhas para seu cliente'}
CMDs[#CMDs + 1] = {NAME = 'unbubblechat / nobubblechat', DESC = 'Desabilita o comando bubblechat'}
CMDs[#CMDs + 1] = {NAME = 'safechat', DESC = 'Habilita chat seguro'}
CMDs[#CMDs + 1] = {NAME = 'nosafechat / disablesafechat', DESC = 'Desabilita safechat'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'esp', DESC = 'Ver todos os jogadores e seu status'}
CMDs[#CMDs + 1] = {NAME = 'noesp / unesp', DESC = 'Remove esp'}
CMDs[#CMDs + 1] = {NAME = 'partesp [part name]', DESC = 'Destaca uma parte'}
CMDs[#CMDs + 1] = {NAME = 'unpartesp / nopartesp [part name]', DESC = 'remove partesp'}
CMDs[#CMDs + 1] = {NAME = 'chams', DESC = 'ESP mas sem texto no caminho'}
CMDs[#CMDs + 1] = {NAME = 'nochams / unchams', DESC = 'Remove chams'}
CMDs[#CMDs + 1] = {NAME = 'locate [plr]', DESC = 'Ver um único jogador e seu status'}
CMDs[#CMDs + 1] = {NAME = 'unlocate / nolocate [plr]', DESC = 'Remove locate'}
CMDs[#CMDs + 1] = {NAME = 'xray', DESC = 'Torna todas as partes no workspace transparentes'}
CMDs[#CMDs + 1] = {NAME = 'unxray / noxray', DESC = 'Restaura a transparência'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'spectate / view [plr]', DESC = 'Ver um jogador'}
CMDs[#CMDs + 1] = {NAME = 'viewpart / viewp [part name]', DESC = 'Ver uma parte'}
CMDs[#CMDs + 1] = {NAME = 'unspectate / unview', DESC = 'Para de ver o jogador'}
CMDs[#CMDs + 1] = {NAME = 'freecam / fc', DESC = 'Permite que você mova a câmera livremente pelo jogo'}
CMDs[#CMDs + 1] = {NAME = 'freecampos / fcpos [X Y Z]', DESC = 'Move / abre freecam em uma certa posição'}
CMDs[#CMDs + 1] = {NAME = 'freecamwaypoint / fcwp [name]', DESC = 'Move / abre freecam para um waypoint'}
CMDs[#CMDs + 1] = {NAME = 'freecamgoto / fcgoto / fctp [plr]', DESC = 'Move / abre freecam para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'unfreecam / unfc', DESC = 'Desabilita freecam'}
CMDs[#CMDs + 1] = {NAME = 'freecamspeed / fcspeed [num]', DESC = 'Ajusta a velocidade do freecam (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = 'notifyfreecamposition / notifyfcpos', DESC = 'Notifica você das coordenadas do seu freecam'}
CMDs[#CMDs + 1] = {NAME = 'copyfreecamposition / copyfcpos', DESC = 'Copia as coordenadas do seu freecam para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'gotocamera / gotocam', DESC = 'Teleporta você para a localização da sua câmera'}
CMDs[#CMDs + 1] = {NAME = 'tweengotocam / tgotocam', DESC = 'Faz tween de você para a localização da sua câmera'}
CMDs[#CMDs + 1] = {NAME = 'firstp', DESC = 'Força a câmera a ir para primeira pessoa'}
CMDs[#CMDs + 1] = {NAME = 'thirdp', DESC = 'Permite que a câmera vá para terceira pessoa'}
CMDs[#CMDs + 1] = {NAME = 'noclipcam / nccam', DESC = 'Permite que a câmera atravesse objetos como paredes'}
CMDs[#CMDs + 1] = {NAME = 'maxzoom [num]', DESC = 'Zoom máximo da câmera'}
CMDs[#CMDs + 1] = {NAME = 'minzoom [num]', DESC = 'Zoom mínimo da câmera'}
CMDs[#CMDs + 1] = {NAME = 'camdistance [num]', DESC = 'Muda a distância da câmera do seu jogador'}
CMDs[#CMDs + 1] = {NAME = 'fov [num]', DESC = 'Ajusta o campo de visão (padrão é 70)'}
CMDs[#CMDs + 1] = {NAME = 'fixcam / restorecam', DESC = 'Corrige a câmera'}
CMDs[#CMDs + 1] = {NAME = 'enableshiftlock / enablesl', DESC = 'Habilita a opção de shift lock'}
CMDs[#CMDs + 1] = {NAME = 'lookat [plr]', DESC = 'Move a visão da sua câmera para um jogador'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'btools (CLIENT)', DESC = 'Dá ferramentas de construção (NÃO REPLICA)'}
CMDs[#CMDs + 1] = {NAME = 'f3x (CLIENT)', DESC = 'Dá ferramentas de construção F3X (NÃO REPLICA)'}
CMDs[#CMDs + 1] = {NAME = 'partname / partpath', DESC = 'Permite que você clique em uma parte para ver seu caminho e nome'}
CMDs[#CMDs + 1] = {NAME = 'delete [instance name] (CLIENT)', DESC = 'Remove qualquer parte com um certo nome do workspace (NÃO REPLICA)'}
CMDs[#CMDs + 1] = {NAME = 'deleteclass / dc [class name] (CLIENT)', DESC = 'Remove qualquer parte com um certo classname do workspace (NÃO REPLICA)'}
CMDs[#CMDs + 1] = {NAME = 'lockworkspace / lockws', DESC = 'Trava todo o workspace'}
CMDs[#CMDs + 1] = {NAME = 'unlockworkspace / unlockws', DESC = 'Destrava todo o workspace'}
CMDs[#CMDs + 1] = {NAME = 'invisibleparts / invisparts (CLIENT)', DESC = 'Mostra partes invisíveis'}
CMDs[#CMDs + 1] = {NAME = 'uninvisibleparts / uninvisparts (CLIENT)', DESC = 'Faz partes afetadas por invisparts voltarem ao normal'}
CMDs[#CMDs + 1] = {NAME = 'deleteinvisparts / dip (CLIENT)', DESC = 'Exclui partes invisíveis'}
CMDs[#CMDs + 1] = {NAME = 'gotopart [part name]', DESC = 'Move seu personagem para uma parte ou múltiplas partes'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopart / tgotopart [part name]', DESC = 'Faz tween do seu personagem para uma parte ou múltiplas partes'}
CMDs[#CMDs + 1] = {NAME = 'gotopartclass / gpc [class name]', DESC = 'Move seu personagem para uma parte ou múltiplas partes baseado no classname'}
CMDs[#CMDs + 1] = {NAME = 'tweengotopartclass / tgpc [class name]', DESC = 'Faz tween do seu personagem para uma parte ou múltiplas partes baseado no classname'}
CMDs[#CMDs + 1] = {NAME = 'gotomodel [part name]', DESC = 'Move seu personagem para um modelo ou múltiplos modelos'}
CMDs[#CMDs + 1] = {NAME = 'tweengotomodel / tgotomodel [part name]', DESC = 'Faz tween do seu personagem para um modelo ou múltiplos modelos'}
CMDs[#CMDs + 1] = {NAME = 'gotopartdelay / gotomodeldelay [num]', DESC = 'Ajusta quão rápido você teleporta para cada parte (padrão é 0.1)'}
CMDs[#CMDs + 1] = {NAME = 'bringpart [part name] (CLIENT)', DESC = 'Move uma parte ou múltiplas partes para seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'bringpartclass / bpc [class name] (CLIENT)', DESC = 'Move uma parte ou múltiplas partes para seu personagem baseado no classname'}
CMDs[#CMDs + 1] = {NAME = 'noclickdetectorlimits / nocdlimits', DESC = 'Define MaxActivationDistance de todos os detectores de clique para math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireclickdetectors / firecd', DESC = 'Usa todos os detectores de clique em um jogo'}
CMDs[#CMDs + 1] = {NAME = 'firetouchinterests / touchinterests', DESC = 'Usa todos os touchinterests em um jogo'}
CMDs[#CMDs + 1] = {NAME = 'noproximitypromptlimits / nopplimits', DESC = 'Define MaxActivationDistance de todos os prompts de proximidade para math.huge'}
CMDs[#CMDs + 1] = {NAME = 'fireproximityprompts / firepp', DESC = 'Usa todos os prompts de proximidade em um jogo'}
CMDs[#CMDs + 1] = {NAME = 'instantproximityprompts / instantpp', DESC = 'Desabilita o cooldown dos prompts de proximidade'}
CMDs[#CMDs + 1] = {NAME = 'uninstantproximityprompts / uninstantpp', DESC = 'Desfaz a remoção do cooldown'}
CMDs[#CMDs + 1] = {NAME = 'tpunanchored / tpua [plr]', DESC = 'Teleporta partes não ancoradas para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'animsunanchored / freezeua', DESC = 'Congela partes não ancoradas'}
CMDs[#CMDs + 1] = {NAME = 'thawunanchored / thawua / unfreezeua', DESC = 'Descongela partes não ancoradas'}
CMDs[#CMDs + 1] = {NAME = 'removeterrain / rterrain / noterrain', DESC = 'Remove todo o terreno'}
CMDs[#CMDs + 1] = {NAME = 'clearnilinstances / nonilinstances / cni', DESC = 'Remove instâncias nil'}
CMDs[#CMDs + 1] = {NAME = 'destroyheight / dh [num]', DESC = 'Define FallenPartsDestroyHeight'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'fullbright / fb (CLIENT)', DESC = 'Torna o mapa mais brilhante / mais visível'}
CMDs[#CMDs + 1] = {NAME = 'loopfullbright / loopfb (CLIENT)', DESC = 'Torna o mapa mais brilhante / mais visível mas em loop'}
CMDs[#CMDs + 1] = {NAME = 'unloopfullbright / unloopfb', DESC = 'Remove loop do fullbright'}
CMDs[#CMDs + 1] = {NAME = 'ambient [num] [num] [num] (CLIENT)', DESC = 'Muda o ambiente'}
CMDs[#CMDs + 1] = {NAME = 'day (CLIENT)', DESC = 'Muda o tempo para dia para o cliente'}
CMDs[#CMDs + 1] = {NAME = 'night (CLIENT)', DESC = 'Muda o tempo para noite para o cliente'}
CMDs[#CMDs + 1] = {NAME = 'nofog (CLIENT)', DESC = 'Remove neblina'}
CMDs[#CMDs + 1] = {NAME = 'brightness [num] (CLIENT)', DESC = 'Muda a propriedade de brilho da iluminação'}
CMDs[#CMDs + 1] = {NAME = 'globalshadows / gshadows (CLIENT)', DESC = 'Habilita sombras globais'}
CMDs[#CMDs + 1] = {NAME = 'noglobalshadows / nogshadows (CLIENT)', DESC = 'Desabilita sombras globais'}
CMDs[#CMDs + 1] = {NAME = 'restorelighting / rlighting', DESC = 'Restaura propriedades de Iluminação'}
CMDs[#CMDs + 1] = {NAME = 'light [radius] [brightness] (CLIENT)', DESC = 'Dá luz dinâmica ao seu jogador'}
CMDs[#CMDs + 1] = {NAME = 'nolight / unlight', DESC = 'Remove luz dinâmica do seu jogador'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'inspect / examine [plr]', DESC = 'Abre InspectMenu para um certo jogador'}
CMDs[#CMDs + 1] = {NAME = 'age [plr]', DESC = 'Diz a idade de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'chatage [plr]', DESC = 'Envia no chat a idade de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'joindate / jd [plr]', DESC = 'Diz a data que o jogador entrou no Roblox'}
CMDs[#CMDs + 1] = {NAME = 'chatjoindate / cjd [plr]', DESC = 'Envia no chat a data que o jogador entrou no Roblox'}
CMDs[#CMDs + 1] = {NAME = 'copyname / copyuser [plr]', DESC = 'Copia o nome de usuário completo de um jogador para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'userid / id [plr]', DESC = 'Notifica o ID de usuário de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'copyuserid / copyid [plr]', DESC = 'Copia o ID de usuário de um jogador para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'appearanceid / aid [plr]', DESC = 'Notifica o ID de aparência de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'copyappearanceid / caid [plr]', DESC = 'Copia o ID de aparência de um jogador para sua área de transferência'}
CMDs[#CMDs + 1] = {NAME = 'bang [plr] [speed]', DESC = 'owo'}
CMDs[#CMDs + 1] = {NAME = 'unbang', DESC = 'uwu'}
CMDs[#CMDs + 1] = {NAME = 'carpet [plr]', DESC = 'Ser o tapete de alguém'}
CMDs[#CMDs + 1] = {NAME = 'uncarpet', DESC = 'Desfaz carpet'}
CMDs[#CMDs + 1] = {NAME = 'friend [plr]', DESC = 'Envia uma solicitação de amizade para certos jogadores'}
CMDs[#CMDs + 1] = {NAME = 'unfriend [plr]', DESC = 'Remove amizade de certos jogadores'}
CMDs[#CMDs + 1] = {NAME = 'headsit [plr]', DESC = 'Sentar na cabeça de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'walkto / follow [plr]', DESC = 'Seguir um jogador'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalkto / pathfindfollow [plr]', DESC = 'Seguir um jogador usando pathfinding'}
CMDs[#CMDs + 1] = {NAME = 'pathfindwalktowaypoint / pathfindwalktowp [waypoint]', DESC = 'Caminhar até um waypoint usando pathfinding'}
CMDs[#CMDs + 1] = {NAME = 'unwalkto / unfollow', DESC = 'Para de seguir um jogador'}
CMDs[#CMDs + 1] = {NAME = 'stareat / stare [plr]', DESC = 'Olhar fixamente para um jogador'}
CMDs[#CMDs + 1] = {NAME = 'unstareat / unstare [plr]', DESC = 'Desabilita stareat'}
CMDs[#CMDs + 1] = {NAME = 'rolewatch [group id] [role name]', DESC = 'Notifica se alguém de um grupo observado entrar no servidor'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchstop / unrolewatch', DESC = 'Desabilita Rolewatch'}
CMDs[#CMDs + 1] = {NAME = 'rolewatchleave', DESC = 'Alterna se você deve sair do jogo se alguém de um grupo observado entrar no servidor'}
CMDs[#CMDs + 1] = {NAME = 'attach [plr] (TOOL)', DESC = 'Anexa você a um jogador (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'kill [plr] (TOOL)', DESC = 'Mata um jogador (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'fastkill [plr] (TOOL)', DESC = 'Mata um jogador (menos confiável) (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'handlekill / hkill [plr] (TOOL)', DESC = 'Mata um jogador usando dano de ferramenta (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'bring [plr] (TOOL)', DESC = 'Traz um jogador (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'fastbring [plr] (TOOL)', DESC = 'Traz um jogador (menos confiável) (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'teleport / tp [plr] [plr] (TOOL)', DESC = 'Teleporta um jogador para outro jogador (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'fastteleport / fasttp [plr] [plr] (TOOL)', DESC = 'Teleporta um jogador para outro jogador (menos confiável) (VOCÊ PRECISA DE UMA FERRAMENTA)'}
CMDs[#CMDs + 1] = {NAME = 'fling', DESC = 'Lança qualquer um que você tocar'}
CMDs[#CMDs + 1] = {NAME = 'unfling', DESC = 'Desabilita o comando fling'}
CMDs[#CMDs + 1] = {NAME = 'invisfling', DESC = 'Habilita fling invisível'}
CMDs[#CMDs + 1] = {NAME = 'loopoof', DESC = 'Loopa os sons do personagem de todos (todos podem ouvir)'}
CMDs[#CMDs + 1] = {NAME = 'unloopoof', DESC = 'Para o caos de oof'}
CMDs[#CMDs + 1] = {NAME = 'muteboombox [plr]', DESC = 'Silencia o boombox de alguém'}
CMDs[#CMDs + 1] = {NAME = 'unmuteboombox [plr]', DESC = 'Desmute o boombox de alguém'}
CMDs[#CMDs + 1] = {NAME = 'hitbox [plr] [size]', DESC = 'Expande a hitbox do HumanoidRootPart dos jogadores (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = 'headsize [plr] [size]', DESC = 'Expande o tamanho da cabeça dos jogadores Head (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = 'Reseta seu personagem normalmente'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = 'Reespawne você'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = 'Reespawne e traz você de volta para a mesma posição'}
CMDs[#CMDs + 1] = {NAME = 'god', DESC = 'Torna seu personagem difícil de matar na maioria dos jogos'}
CMDs[#CMDs + 1] = {NAME = 'invisible / invis', DESC = 'Torna você invisível para outros jogadores'}
CMDs[#CMDs + 1] = {NAME = 'visible / vis', DESC = 'Torna você visível para outros jogadores'}
CMDs[#CMDs + 1] = {NAME = 'toolinvisible / toolinvis / tinvis', DESC = 'Torna você invisível para outros jogadores e capaz de usar ferramentas'}
CMDs[#CMDs + 1] = {NAME = 'speed / ws / walkspeed [num]', DESC = 'Muda sua velocidade de caminhada'}
CMDs[#CMDs + 1] = {NAME = 'spoofspeed / spoofws [num]', DESC = 'Falsifica sua WalkSpeed no Cliente'}
CMDs[#CMDs + 1] = {NAME = 'loopspeed / loopws [num]', DESC = 'Loopa sua velocidade de caminhada'}
CMDs[#CMDs + 1] = {NAME = 'unloopspeed / unloopws', DESC = 'Desliga loopspeed'}
CMDs[#CMDs + 1] = {NAME = 'hipheight / hheight [num]', DESC = 'Ajusta a altura do quadril'}
CMDs[#CMDs + 1] = {NAME = 'jumppower / jpower / jp [num]', DESC = 'Muda a altura do pulo de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'spoofjumppower / spoofjp [num]', DESC = 'Falsifica seu JumpPower no Cliente'}
CMDs[#CMDs + 1] = {NAME = 'loopjumppower / loopjp [num]', DESC = 'Loopa sua altura de pulo'}
CMDs[#CMDs + 1] = {NAME = 'unloopjumppower / unloopjp', DESC = 'Desliga loopjumppower'}
CMDs[#CMDs + 1] = {NAME = 'maxslopeangle / msa [num]', DESC = 'Ajusta MaxSlopeAngle'}
CMDs[#CMDs + 1] = {NAME = 'gravity / grav [num] (CLIENT)', DESC = 'Muda sua gravidade'}
CMDs[#CMDs + 1] = {NAME = 'sit', DESC = 'Faz seu personagem sentar'}
CMDs[#CMDs + 1] = {NAME = 'lay / laydown', DESC = 'Faz seu personagem deitar'}
CMDs[#CMDs + 1] = {NAME = 'sitwalk', DESC = 'Faz seu personagem sentar enquanto ainda consegue caminhar'}
CMDs[#CMDs + 1] = {NAME = 'nosit', DESC = 'Impede que seu personagem sente'}
CMDs[#CMDs + 1] = {NAME = 'unnosit', DESC = 'Desabilita nosit'}
CMDs[#CMDs + 1] = {NAME = 'jump', DESC = 'Faz seu personagem pular'}
CMDs[#CMDs + 1] = {NAME = 'infinitejump / infjump', DESC = 'Permite que você pule antes de tocar o chão'}
CMDs[#CMDs + 1] = {NAME = 'uninfinitejump / uninfjump', DESC = 'Desabilita infjump'}
CMDs[#CMDs + 1] = {NAME = 'flyjump', DESC = 'Permite que você segure espaço para voar para cima'}
CMDs[#CMDs + 1] = {NAME = 'unflyjump', DESC = 'Desabilita flyjump'}
CMDs[#CMDs + 1] = {NAME = 'autojump / ajump', DESC = 'Pula automaticamente quando você corre contra um objeto'}
CMDs[#CMDs + 1] = {NAME = 'unautojump / unajump', DESC = 'Desabilita autojump'}
CMDs[#CMDs + 1] = {NAME = 'edgejump / ejump', DESC = 'Pula automaticamente quando você chega na borda de um objeto'}
CMDs[#CMDs + 1] = {NAME = 'unedgejump / unejump', DESC = 'Desabilita edgejump'}
CMDs[#CMDs + 1] = {NAME = 'platformstand / stun', DESC = 'Habilita PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'unplatformstand / unstun', DESC = 'Desabilita PlatformStand'}
CMDs[#CMDs + 1] = {NAME = 'norotate / noautorotate', DESC = 'Desabilita AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'unnorotate / autorotate', DESC = 'Habilita AutoRotate'}
CMDs[#CMDs + 1] = {NAME = 'enablestate [StateType]', DESC = 'Habilita um tipo de estado de humanoid'}
CMDs[#CMDs + 1] = {NAME = 'disablestate [StateType]', DESC = 'Desabilita um tipo de estado de humanoid'}
CMDs[#CMDs + 1] = {NAME = 'team [team name] (CLIENT)', DESC = 'Muda seu time. Às vezes engana localscripts.'}
CMDs[#CMDs + 1] = {NAME = 'nobillboardgui / nobgui / noname', DESC = 'Remove billboard e surface guis dos seus jogadores (ex: guis de nome em cafés)'}
CMDs[#CMDs + 1] = {NAME = 'loopnobgui / loopnoname', DESC = 'Loop remove billboard e surface guis dos seus jogadores (ex: guis de nome em cafés)'}
CMDs[#CMDs + 1] = {NAME = 'unloopnobgui / unloopnoname', DESC = 'Desabilita loopnobgui'}
CMDs[#CMDs + 1] = {NAME = 'nohead / headless', DESC = 'Remove sua cabeça (usa simulation radius)'}
CMDs[#CMDs + 1] = {NAME = 'noarms', DESC = 'Remove seus braços'}
CMDs[#CMDs + 1] = {NAME = 'nolegs', DESC = 'Remove suas pernas'}
CMDs[#CMDs + 1] = {NAME = 'nolimbs', DESC = 'Remove seus membros'}
CMDs[#CMDs + 1] = {NAME = 'naked (CLIENT)', DESC = 'Remove suas roupas'}
CMDs[#CMDs + 1] = {NAME = 'noface / removeface', DESC = 'Remove seu rosto'}
CMDs[#CMDs + 1] = {NAME = 'blockhead', DESC = 'Transforma sua cabeça em um bloco'}
CMDs[#CMDs + 1] = {NAME = 'blockhats', DESC = 'Transforma seus chapéus em blocos'}
CMDs[#CMDs + 1] = {NAME = 'blocktool', DESC = 'Transforma a ferramenta atualmente selecionada em um bloco'}
CMDs[#CMDs + 1] = {NAME = 'creeper', DESC = 'Faz você parecer um creeper'}
CMDs[#CMDs + 1] = {NAME = 'drophats', DESC = 'Dropa seus chapéus'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats', DESC = 'Exclui seus chapéus'}
CMDs[#CMDs + 1] = {NAME = 'hatspin / spinhats', DESC = 'Gira os acessórios do seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'unhatspin / unspinhats', DESC = 'Desfaz spinhats'}
CMDs[#CMDs + 1] = {NAME = 'clearhats / cleanhats', DESC = 'Limpa chapéus no workspace'}
CMDs[#CMDs + 1] = {NAME = 'chardelete / cd [instance name]', DESC = 'Remove qualquer parte com um certo nome do seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'chardeleteclass / cdc [class name]', DESC = 'Remove qualquer parte com um certo classname do seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'deletevelocity / dv / removeforces', DESC = 'Remove qualquer instância de velocidade / força no seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'weaken [num]', DESC = 'Torna seu personagem menos denso'}
CMDs[#CMDs + 1] = {NAME = 'unweaken', DESC = 'Define CustomPhysicalProperties do seu personagem para padrão'}
CMDs[#CMDs + 1] = {NAME = 'strengthen [num]', DESC = 'Torna seu personagem mais denso (CustomPhysicalProperties)'}
CMDs[#CMDs + 1] = {NAME = 'unstrengthen', DESC = 'Define CustomPhysicalProperties do seu personagem para padrão'}
CMDs[#CMDs + 1] = {NAME = 'breakvelocity', DESC = 'Define a velocidade do seu personagem para 0'}
CMDs[#CMDs + 1] = {NAME = 'spin [speed]', DESC = 'Gira seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'unspin', DESC = 'Desabilita spin'}
CMDs[#CMDs + 1] = {NAME = 'vr', DESC = 'Carrega CLOVR por Abacaxl'}
CMDs[#CMDs + 1] = {NAME = 'split', DESC = 'Divide seu personagem ao meio'}
CMDs[#CMDs + 1] = {NAME = 'nilchar', DESC = 'Define o parent do seu personagem para nil'}
CMDs[#CMDs + 1] = {NAME = 'unnilchar / nonilchar', DESC = 'Define o parent do seu personagem para workspace'}
CMDs[#CMDs + 1] = {NAME = 'noroot / removeroot / rroot', DESC = 'Remove HumanoidRootPart do seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'replaceroot', DESC = 'Substitui HumanoidRootPart do seu personagem'}
CMDs[#CMDs + 1] = {NAME = 'clearcharappearance / clearchar / clrchar', DESC = 'Remove todos os acessórios, camisa, calças, charactermesh e bodycolors'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'animation / anim [ID] [speed]', DESC = 'Faz seu personagem executar uma animação (deve ser do roblox para replicar)'}
CMDs[#CMDs + 1] = {NAME = 'dance', DESC = 'Faz você  d a n ç a r'}
CMDs[#CMDs + 1] = {NAME = 'undance', DESC = 'Para animações de dança'}
CMDs[#CMDs + 1] = {NAME = 'spasm', DESC = 'Faz você  f i c a r  l o u c o'}
CMDs[#CMDs + 1] = {NAME = 'unspasm', DESC = 'Para espasmo'}
CMDs[#CMDs + 1] = {NAME = 'headthrow', DESC = 'Simplesmente faz você jogar sua cabeça'}
CMDs[#CMDs + 1] = {NAME = 'noanim', DESC = 'Desabilita suas animações'}
CMDs[#CMDs + 1] = {NAME = 'reanim', DESC = 'Restaura suas animações'}
CMDs[#CMDs + 1] = {NAME = 'animspeed [num]', DESC = 'Muda a velocidade da sua animação atual'}
CMDs[#CMDs + 1] = {NAME = 'copyanimation / copyanim / copyemote [plr]', DESC = 'Copia a animação de outra pessoa'}
CMDs[#CMDs + 1] = {NAME = 'loopanimation / loopanim', DESC = 'Loopa sua animação atual'}
CMDs[#CMDs + 1] = {NAME = 'stopanimations / stopanims', DESC = 'Para animações em execução'}
CMDs[#CMDs + 1] = {NAME = 'refreshanimations / refreshanims', DESC = 'Atualiza animações'}
CMDs[#CMDs + 1] = {NAME = 'allowcustomanim / allowcustomanimations', DESC = 'Permite que você use pacotes de animação personalizados'}
CMDs[#CMDs + 1] = {NAME = 'unallowcustomanim / unallowcustomanimations', DESC = 'Doesn\'t let you use custom animation packs instead'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'autoclick [click delay] [release delay]', DESC = 'Clica automaticamente seu mouse com um atraso definido'}
CMDs[#CMDs + 1] = {NAME = 'unautoclick / noautoclick', DESC = 'Desliga autoclick'}
CMDs[#CMDs + 1] = {NAME = 'autokeypress [key] [down delay] [up delay]', DESC = 'Pressiona automaticamente uma tecla com um atraso definido'}
CMDs[#CMDs + 1] = {NAME = 'unautokeypress', DESC = 'Para autokeypress'}
CMDs[#CMDs + 1] = {NAME = 'hovername', DESC = 'Mostra o nome de usuário de um jogador quando seu mouse está sobre ele'}
CMDs[#CMDs + 1] = {NAME = 'unhovername / nohovername', DESC = 'Desliga hovername'}
CMDs[#CMDs + 1] = {NAME = 'mousesensitivity / ms [0-10]', DESC = 'Define a sensibilidade do seu mouse (afeta primeira pessoa e arrasto com botão direito) (padrão é 1)'}
CMDs[#CMDs + 1] = {NAME = 'clickdelete', DESC = 'Vá para configurações>Teclas de Atalho>Adicionar para clicktp'}
CMDs[#CMDs + 1] = {NAME = 'clickteleport', DESC = 'Vá para configurações>Teclas de Atalho>Adicionar para click tp'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'tools', DESC = 'Copia ferramentas de ReplicatedStorage e Lighting'}
CMDs[#CMDs + 1] = {NAME = 'notools / removetools / deletetools', DESC = 'Remove ferramentas do personagem e mochila'}
CMDs[#CMDs + 1] = {NAME = 'deleteselectedtool / dst', DESC = 'Remove qualquer ferramenta atualmente selecionada'}
CMDs[#CMDs + 1] = {NAME = 'grabtools', DESC = 'Pega automaticamente ferramentas que são dropadas'}
CMDs[#CMDs + 1] = {NAME = 'ungrabtools / nograbtools', DESC = 'Desabilita grabtools'}
CMDs[#CMDs + 1] = {NAME = 'copytools [plr] (CLIENT)', DESC = 'Copia as ferramentas de um jogador'}
CMDs[#CMDs + 1] = {NAME = 'dupetools / clonetools [num]', DESC = 'Duplica suas ferramentas de inventário uma quantidade definida de vezes'}
CMDs[#CMDs + 1] = {NAME = 'givetool / givetools', DESC = 'Gives all the tools you\'re holding to [plr] using the attach method.'}
CMDs[#CMDs + 1] = {NAME = 'droptools', DESC = 'Dropa suas ferramentas'}
CMDs[#CMDs + 1] = {NAME = 'droppabletools', DESC = 'Torna suas ferramentas droppable'}
CMDs[#CMDs + 1] = {NAME = 'equiptools', DESC = 'Equipa cada ferramenta do seu inventário de uma vez'}
CMDs[#CMDs + 1] = {NAME = 'unequiptools', DESC = 'Desequipa cada ferramenta que você está segurando de uma vez'}
CMDs[#CMDs + 1] = {NAME = 'removespecifictool [name]', DESC = 'Remove automaticamente uma ferramenta específica do seu inventário'}
CMDs[#CMDs + 1] = {NAME = 'unremovespecifictool [name]', DESC = 'Para de remover uma ferramenta específica do seu inventário'}
CMDs[#CMDs + 1] = {NAME = 'clearremovespecifictool', DESC = 'Para de remover todas as ferramentas específicas do seu inventário'}
CMDs[#CMDs + 1] = {NAME = 'reach [num]', DESC = 'Aumenta a hitbox da sua ferramenta segurada'}
CMDs[#CMDs + 1] = {NAME = 'unreach / noreach', DESC = 'Desliga reach'}
CMDs[#CMDs + 1] = {NAME = 'grippos [X Y Z]', DESC = 'Muda a posição de pegada da sua ferramenta atual'}
CMDs[#CMDs + 1] = {NAME = 'usetools [ammount] [delay]', DESC = 'Ativa todas as ferramentas da sua mochila ao mesmo tempo'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addalias [cmd] [alias]', DESC = 'Adiciona um alias a um comando'}
CMDs[#CMDs + 1] = {NAME = 'removealias [alias]', DESC = 'Remove um alias personalizado'}
CMDs[#CMDs + 1] = {NAME = 'clraliases', DESC = 'Remove todos os aliases personalizados'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'addplugin / plugin [name]', DESC = 'Adiciona um plugin via comando'}
CMDs[#CMDs + 1] = {NAME = 'removeplugin / deleteplugin [name]', DESC = 'Remove um plugin via comando'}
CMDs[#CMDs + 1] = {NAME = 'reloadplugin [name]', DESC = 'Recarrega um plugin'}
CMDs[#CMDs + 1] = {NAME = '', DESC = ''}
CMDs[#CMDs + 1] = {NAME = 'breakloops / break (cmd loops)', DESC = 'Para qualquer loop de cmd (;100^1^cmd)'}
CMDs[#CMDs + 1] = {NAME = 'removecmd / deletecmd', DESC = 'Remove um comando até que o admin seja recarregado'}
CMDs[#CMDs + 1] = {NAME = 'tpwalk / teleportwalk [num]', DESC = 'Teleporta você para sua direção de movimento'}
CMDs[#CMDs + 1] = {NAME = 'untpwalk / unteleportwalk', DESC = 'Desfaz tpwalk / teleportwalk'}
CMDs[#CMDs + 1] = {NAME = 'notifyping / ping', DESC = 'Notifica você do seu ping'}
CMDs[#CMDs + 1] = {NAME = 'trip', DESC = 'Faz seu personagem cair'}
CMDs[#CMDs + 1] = {NAME = 'norender', DESC = 'Desabilita Renderização 3D para diminuir a quantidade de CPU que o cliente usa'}
CMDs[#CMDs + 1] = {NAME = 'render', DESC = 'Habilita Renderização 3D'}
wait()
				...
				for a,c in pairs(CMDsF:GetChildren()) do
					if string.find(c.Text, "^"..cmd.."$") or string.find(c.Text, "^"..cmd.." ") or string.find(c.Text, " "..cmd.."$") or string.find(c.Text, " "..cmd.." ") then
						...
						c.MouseButton1Click:Connect(function()
							notify(c.Text, "Comando foi desabilitado por você ou um plugin")
						end)
					end
				end
			end
...
function unkeybind(cmd,key)
	...
	if key == 'RightClick' or key == 'LeftClick' then
		notify('Teclas de Atalho Atualizadas','Desvinculado '..key..' de '..cmd)
	else
...
Add_2.MouseButton1Click:Connect(function()
	if keySelected then
		if string.find(Cmdbar_2.Text, "\\\\") or string.find(Cmdbar_3.Text, "\\\\") then
			notify('Erro de Tecla de Atalho','Use apenas uma barra invertida para vincular múltiplos comandos a uma tecla de atalho ou comando')
		else
			...
			if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
				notify('Teclas de Atalho Atualizadas','Vinculado '..keyPressed..' a '..Cmdbar_2.Text..(newToggle and " / "..Cmdbar_3.Text or ""))
			else
...
ClickTP.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('Teclas de Atalho Atualizadas','Vinculado '..keyPressed..' a teleporte por clique')
		else
...
ClickDelete.Select.MouseButton1Click:Connect(function()
	if keySelected then
		...
		updatesaves()
		if keyPressed == 'RightClick' or keyPressed == 'LeftClick' then
			notify('Teclas de Atalho Atualizadas','Vinculado '..keyPressed..' a excluir por clique')
		else
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'iy_fe.iy' or name == 'iy_fe' then
		notify('Erro de Plugin','Por favor, insira um plugin válido')
	else
		local file
		local fileName
		...
		if file then
			if not FindInTable(PluginsTable, fileName) then
				...
				notify('Erro de Plugin','Este plugin já foi adicionado')
			end
		else
			notify('Erro de Plugin','Não foi possível localizar o arquivo "'..fileName..'". O arquivo está na pasta correta?')
		end
	end
end
...
function deletePlugin(name)
	...
	for i,v in pairs(PluginsTable) do
		if v == pName then
			...
			notify('Plugin Removido',pName..' foi removido')
		end
	end
	IndexContents('',true)
	refreshplugins()
...
function LoadPlugin(val,startup)
	...
	function handlePluginError(plerror)
		notify('Erro de Plugin','Ocorreu um erro com o plugin "'..val..'" e ele não pôde ser carregado')
	...
	if plugin ~= nil then
		if not startup then
			notify('Plugin Carregado',"Nome: "..plugin["PluginName"].."\n".."Descrição: "..plugin["PluginDescription"])
		end
		addcmdtext('',val)
...
Plugins.MouseButton1Click:Connect(function()
	if writefileExploit() then
		...
		notify('Exploit Incompatível','Seu exploit não consegue usar plugins (falta read/writefile)')
	end
end)
...
addcmd('addalias',{},function(args, speaker)
	...
	for i,v in pairs(cmds) do
		if v.NAME:lower()==cmd or FindInTable(v.ALIAS,cmd) then
			...
			notify('Aliases Modificados',"Adicionado "..alias.." como alias para "..cmd)
			updatesaves()
			refreshaliases()
			break
		end
...
addcmd('removealias',{},function(args, speaker)
	...
	if customAlias[alias] then
		...
		notify('Aliases Modificados',"Removido o alias "..alias.." de "..cmd)
		updatesaves()
		refreshaliases()
	end
end)
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		...
		notify('Convite do Discord', 'Copiado para a área de transferência!\ndiscord.gg/dYHag43eeU')
	else
		notify('Convite do Discord', 'discord.gg/dYHag43eeU')
	end
	if httprequest then
		httprequest({
...
addcmd('keepiy', {}, function(args, speaker)
	if queueteleport then
		...
		notify('Exploit Incompatível','Seu exploit não suporta este comando (falta queue_on_teleport)')
	end
end)
...
addcmd('autorejoin',{'autorj'},function(args, speaker)
	...
	notify('Reconexão Automática','Reconexão automática ativada')
end)
...
addcmd('serverhop',{'shop'},function(args, speaker)
	...
	if httprequest then
		...
		if #servers > 0 then
			...
			return notify("Trocar Servidor", "Não foi possível encontrar um servidor.")
		end
	end
end)
	...
	function ToServer(User,PlaceId)	
		...
		if not pcall(function()
				...
				if not FoundUser then
					notify('Erro de Entrada','Nome de usuário/ID de usuário não existe')
				else
					notify('Entrar com Jogador','Carregando servidores. Aguarde um momento.')
					...
					if GUID ~= nil then
						notify('Entrar com Jogador','Entrando com '..User)
						TeleportService:TeleportToPlaceInstance(PlaceId,GUID,Players.LocalPlayer)
					else
						notify('Erro de Entrada','Não foi possível entrar com o usuário.')
					end
				end
			end)
		then
			if retries < 3 then
				...
				notify('Erro de Entrada','Erro ao tentar entrar. Tentando novamente '..retries..'/3.')
				ToServer(User,PlaceId)
			else
				notify('Erro de Entrada','Erro ao tentar entrar.')
			end
		end
	end
...
addcmd('float', {'platform'},function(args, speaker)
	...
	if pchar and not pchar:FindFirstChild(floatName) then
		task.spawn(function()
			...
			notify('Flutuar','Flutuar Ativado (Q = para baixo e E = para cima)')
...
addcmd('unfloat',{'nofloat','unplatform','noplatform'},function(args, speaker)
	Floating = false
	local pchar = speaker.Character
	notify('Flutuar','Flutuar Desativado')
