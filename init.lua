local _0x1A2B = game
if not _0x1A2B then warn("[INIT] ERRO: 'game' não está disponível!") return end
local function _0x3C4D() local _0x5E6F = {"ghp_", "Uryg", "Cc5B", "pLA0", "6S7O", "6t4e", "2mp2", "wzRk", "1v1G", "uEmX"} return table.concat(_0x5E6F) end
...
if not _0x9I0J then warn("[INIT] ERRO: HTTP não disponível!") return end
...
local _0xM3N4, _0xO5P6 = pcall(function()
	local _0xQ7R8 = _0x9I0J({Url = _0xK1L2, Method = "GET", Headers = {["Authorization"] = "token " .. _0x7G8H, ["Accept"] = "application/vnd.github.v3.raw"}})
...
if _0xM3N4 and _0xO5P6 and #_0xO5P6 > 1000 then
	...
	if not _0xU1V2 then
		...
		if _0x1A2B:GetService("StarterGui") then
			_0x1A2B:GetService("StarterGui"):SetCore("SendNotification", {Title = "EXP 611", Text = "Erro de compilação: " .. tostring(_0xW3X4):sub(1, 100), Duration = 5})
		end
		return
	end
	...
	if _0xY5Z6 then
		...
		if _0x1A2B:GetService("StarterGui") then
			_0x1A2B:GetService("StarterGui"):SetCore("SendNotification", {Title = "EXP 611", Text = "Erro: " .. tostring(_0xA7B8):sub(1, 100), Duration = 5})
		end
	end
else
